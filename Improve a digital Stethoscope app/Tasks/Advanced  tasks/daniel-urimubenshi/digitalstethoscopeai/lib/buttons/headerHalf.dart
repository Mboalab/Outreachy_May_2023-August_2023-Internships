            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: GestureDetector(
                  onLongPress: () async {
                    await RecordUtil.record();
                    Toast.show("Recording has started",
                        duration: Toast.lengthLong, gravity: Toast.bottom);
                    setState(() {});
                  },
                  onLongPressEnd: (details) async {
                    await RecordUtil.stopRecord();
                    Toast.show("Recording has ended",
                        duration: Toast.lengthLong, gravity: Toast.bottom);
                    ref.read(refleshRecordingList.notifier).state = {
                      'refreshlist': true
                    };
                  },
                  child: Image.asset(
